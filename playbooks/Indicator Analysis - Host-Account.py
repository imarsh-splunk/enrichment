...
def merge_list_user(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.custom_function(custom_function='community/list_merge', parameters=parameters, name='merge_list_user', callback=get_customer_info)
...
def merge_system_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:user_system_filter:condition_2:artifact:*.cef.destinationHostName', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.dhost', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.sourceHostName', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.shost', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.hostname', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.dest', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.dest_nt_host'])
    ...
    # call custom function "community/list_merge", returns the custom_function_run_id
    phantom.custom_function(custom_function='community/list_merge', parameters=parameters, name='merge_system_list', callback=get_system_info)
