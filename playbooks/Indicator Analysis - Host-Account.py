...
def user_system_filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    if matched_artifacts_1 or matched_results_1:
        merge_list_user(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
    ...
    if matched_artifacts_2 or matched_results_2:
        merge_system_list(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_2, filtered_results=matched_results_2)
...
def get_customer_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    custom_function_results_data_1 = phantom.collect2(container=container, datapath=['merge_list_user:custom_function_result.data.*.item'], action_results=results)
...
def get_system_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    custom_function_results_data_1 = phantom.collect2(container=container, datapath=['merge_system_list:custom_function_result.data.*.item'], action_results=results)
...
"""
def merge_list_user(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('merge_list_user() called')
    
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:user_system_filter:condition_1:artifact:*.cef.destinationUserId', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.destinationUserName', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.duser', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.duid', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.sourceUserId', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.sourceUserName', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.suser', 'filtered-data:user_system_filter:condition_1:artifact:*.cef.suid'])
    ...
    phantom.custom_function(custom_function='escu/list_merge_dedup', parameters=parameters, name='merge_list_user', callback=get_customer_info)

    return

def merge_system_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('merge_system_list() called')
    
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:user_system_filter:condition_2:artifact:*.cef.destinationHostName', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.dhost', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.shost', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.dest_nt_host', 'filtered-data:user_system_filter:condition_2:artifact:*.cef.src_nt_host'])
    ...
    parameters.append({
        ...
        'input_2': filtered_artifacts_data_0_1,
        'input_3': filtered_artifacts_data_0_2,
        'input_4': filtered_artifacts_data_0_2,
        'input_5': filtered_artifacts_data_0_3,
        'input_6': filtered_artifacts_data_0_4,
        'input_7': None,
        'input_8': None,
        'input_9': None,
        'input_10': None,
    ...
    # call custom function "escu/list_merge_dedup", returns the custom_function_run_id
    phantom.custom_function(custom_function='escu/list_merge_dedup', parameters=parameters, name='merge_system_list', callback=get_system_info)
