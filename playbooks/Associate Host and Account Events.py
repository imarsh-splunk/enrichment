...
def host_user_filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    if matched_artifacts_1 or matched_results_1:
        merge_host_info(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)

    return

def merge_host_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('merge_host_info() called')
    
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:host_user_filter:condition_1:artifact:*.cef.dest', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.dest_ip', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.destinationHostName', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.dhost', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.dest_nt_host', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.src', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.src_ip', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.sourceAddress', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.sourceHostName', 'filtered-data:host_user_filter:condition_1:artifact:*.cef.shost'])
    ...
    phantom.custom_function(custom_function='ps-playbooks-dev/list_merge_dedup', parameters=parameters, name='merge_host_info', callback=indicator_host_url)

    return

def merge_user_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('merge_user_info() called')
    ...
    # call custom function "ps-playbooks-dev/list_merge_dedup", returns the custom_function_run_id
    phantom.custom_function(custom_function='ps-playbooks-dev/list_merge_dedup', parameters=parameters, name='merge_user_info', callback=indicator_userid_url)
...
%%"""
    ...
    parameters = [
        "merge_host_info:custom_function_result.data.*.item",
    ]
...
%%"""
    ...
    # parameter list for template variable replacement
    parameters = [
        "merge_user_info:custom_function_result.data.*.item",
    ]
...
def user_info_filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call connected blocks if filtered artifacts or results
    if matched_artifacts_1 or matched_results_1:
        merge_user_info(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)
