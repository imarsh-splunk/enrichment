...
def merge_host_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.custom_function(custom_function='escu/list_merge_dedup', parameters=parameters, name='merge_host_info', callback=indicator_host_url)
...
def merge_user_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call custom function "escu/list_merge_dedup", returns the custom_function_run_id
    phantom.custom_function(custom_function='escu/list_merge_dedup', parameters=parameters, name='merge_user_info', callback=indicator_userid_url)
