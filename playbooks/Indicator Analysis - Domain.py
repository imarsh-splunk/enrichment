...
def merge_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:domain_filter:condition_1:artifact:*.cef.destinationDnsDomain', 'filtered-data:domain_filter:condition_1:artifact:*.cef.deviceDnsDomain', 'filtered-data:domain_filter:condition_1:artifact:*.cef.dntdom', 'filtered-data:domain_filter:condition_1:artifact:*.cef.sntdom', 'filtered-data:domain_filter:condition_1:artifact:*.cef.sourceDnsDomain'])
