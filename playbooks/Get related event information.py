...
def user_and_host_filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched_artifacts_2, matched_results_2 = phantom.condition(
        ...
        conditions=[
            ...
            ["artifact:*.cef.src", "==", "custom_list:bogon_list"],
...
def merge_usernames(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:user_and_host_filter:condition_1:artifact:*.cef.sourceUserId', 'filtered-data:user_and_host_filter:condition_1:artifact:*.cef.sourceUserName', 'filtered-data:user_and_host_filter:condition_1:artifact:*.cef.suser', 'filtered-data:user_and_host_filter:condition_1:artifact:*.cef.destinationUserId', 'filtered-data:user_and_host_filter:condition_1:artifact:*.cef.destinationUserName', 'filtered-data:user_and_host_filter:condition_1:artifact:*.cef.duser'])
    ...
    phantom.custom_function(custom_function='ps-playbooks-dev/list_merge_dedup', parameters=parameters, name='merge_usernames', callback=format_user_spl_query)
...
def merge_hostnames(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:user_and_host_filter:condition_2:artifact:*.cef.destinationAddress', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.destinationHostName', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.dest', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.dest_ip', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.sourceAddress', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.sourceHostName', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.src', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.src_ip', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.dest_nt_host', 'filtered-data:user_and_host_filter:condition_2:artifact:*.cef.src_nt_host'])
    ...
    # call custom function "ps-playbooks-dev/list_merge_dedup", returns the custom_function_run_id
    phantom.custom_function(custom_function='ps-playbooks-dev/list_merge_dedup', parameters=parameters, name='merge_hostnames', callback=format_host_spl_query)
