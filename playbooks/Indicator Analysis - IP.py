...
def merge_dedup_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    filtered_artifacts_data_0 = phantom.collect2(container=container, datapath=['filtered-data:ip_address_filter:condition_1:artifact:*.cef.destinationAddress', 'filtered-data:ip_address_filter:condition_1:artifact:*.cef.dest_ip', 'filtered-data:ip_address_filter:condition_1:artifact:*.cef.sourceAddress', 'filtered-data:ip_address_filter:condition_1:artifact:*.cef.src_ip', 'filtered-data:ip_address_filter:condition_1:artifact:*.cef.src', 'filtered-data:ip_address_filter:condition_1:artifact:*.cef.dest'])
    ...
    phantom.custom_function(custom_function='escu/list_merge_dedup', parameters=parameters, name='merge_dedup_list', callback=merge_dedup_list_callback)
