...
def associate_host_and_account_events(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Associate Host and Account Events", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Associate Host and Account Events", container=container, name="associate_host_and_account_events", callback=decide_event_disposition)
