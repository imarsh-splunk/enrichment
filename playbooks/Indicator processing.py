...
def artifact_check(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    if matched:
        get_proces_information(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
        return
...
def filehash_playbook(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Indicator Analysis - Filehash", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Indicator Analysis - Filehash", container=container)
...
def ip_playbook(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Indicator Analysis - IP", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Indicator Analysis - IP", container=container)
...
def domain_playbook(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Indicator Analysis - Domain", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Indicator Analysis - Domain", container=container)
...
def url_playbook(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Indicator Analysis - URL", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Indicator Analysis - URL", container=container)
...
def host_user_analysis(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Indicator Analysis - Host-Account", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Indicator Analysis - Host-Account", container=container)
...
def get_proces_information(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('get_proces_information() called')
    
    # call playbook "ps-playbooks-dev/Get process information", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Get process information", container=container)
...
def get_network_information(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Get network process information", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Get network process information", container=container)
    join_set_container_attributes(container=container)
...
def get_related_events(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    # call playbook "ps-playbooks-dev/Get related event information", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="ps-playbooks-dev/Get related event information", container=container)
