...
args_exclude_whitelisted_artifacts = True
args_set_source_data_identifier = False

####################################################################################################

whitelist_domains = ['www.virustotal.com', 'gsk.com', 'GSK.COM', 'urldefense.com', 'www.microsoft.com',
...
re_dns = re.compile(r"^([a-z0-9_]+\.)+([a-z0-9]+)$", flags=re.IGNORECASE)
